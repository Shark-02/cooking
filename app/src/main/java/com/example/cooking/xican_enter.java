...
public class xican_enter extends AppCompatActivity {

    List<recipe> xican_data;
    MyAdapter ma;
    RecyclerView rcv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xican_enter);

        //这里是Back
        ImageView home_cooking_back=findViewById(R.id.xican_back);
    ...
    void SetupAdapter(){
        xican_data= new ArrayList<>();
        MyDatabaseHelper dbHelper = new MyDatabaseHelper(this,"Cooking.db",null,1);
        SQLiteDatabase db = dbHelper.getWritableDatabase();
        Cursor cursor=db.query("Menu",null,null,null,"menu_id","menu_id>30",null);
        Cursor cursor1 = db.rawQuery("select title,pic from Menu,Picture where Picture.id=cover and cover>30" ,null);
        int count =0;
        ...
        cursor.close();
        cursor1.close();
        ma=new MyAdapter(R.layout.view_list_itemlayout,xican_data);
        rcv=findViewById(R.id.xican_content);
        ...
        ma.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(@NonNull BaseQuickAdapter adapter, @NonNull View view, int position) {
                ...
                Intent intent = new Intent(xican_enter.this, Menu.class);
                intent.putExtra("title",xican_data.get(position).title);
