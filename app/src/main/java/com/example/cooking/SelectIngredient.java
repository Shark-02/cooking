...
public class SelectIngredient extends AppCompatActivity {
    ...
    private Fragment_hot Hot=new Fragment_hot();
    private Fragment_meatt Meat=new Fragment_meatt();
    private Fragment_seafood Seafood=new Fragment_seafood();
    private Fragment_vegetable Vegetable=new Fragment_vegetable();
    private Fragment_fruit Fruit=new Fragment_fruit();
    private Fragment_rice Rice=new Fragment_rice();
    private Fragment_bean Bean=new Fragment_bean();
    private Fragment_spice Spice=new Fragment_spice();
    private Fragment_oil Oil=new Fragment_oil();
    private Fragment_water Water=new Fragment_water();
    private Fragment_others Other=new Fragment_others();
